...
import IngredientList from '../Categories/IngredientList';
import CategoryList from '../Categories/CategoryList';
import CategoryList from '../Categories/CategoryList';
import CategoryList from '../Categories/CategoryList';
  ...
  const renderContent = () => {
    switch (selectedMenu) {
      ...
      case '2':
        return <CategoryList />;
      case '3':
        return <div className="p-6"><h1 className="text-2xl font-bold">Users Management</h1></div>;
      case '4':
        return <div className="p-6"><h1 className="text-2xl font-bold">Orders Management</h1></div>;
      case '5':
